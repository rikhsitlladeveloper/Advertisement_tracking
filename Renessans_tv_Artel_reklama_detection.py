...
model = torch.hub.load('ultralytics/yolov5','custom', path='new_m.pt')
print("Model Loaded")
...
video_path = 'https://api.itv.uz/hls/iptv/1221/index.m3u8?type=live&&token=artel'  # Change this to your video file's path
